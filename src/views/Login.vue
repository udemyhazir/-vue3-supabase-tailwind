...
<form @submit.prevent="login" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
  <h1 class="text-3xl text-at-light-orange mb-4">Sisteme Giriş Sayfası</h1>
  ...
  <div class="flex flex-col mb-2">
    <label for="password" class="mb-1 text-sm text-at-light-orange">Parola:</label>
  ...
  bg-at-light-orange duration-200 border-solid border-2 
  border-transparent hover:border-white hover:bg-white hover:text-at-light-orange">Giriş</button>

  <router-link class="text-sm mt-6 text-center" :to="{name:'Register'}">Üye değiseniz 
  <span class="text-at-light-green">Üye olunuz</span> </router-link>
</form>
